#alright, so turns out pasting it removes all format, so you don't get the fun colours that Visual Studio has, but I guess I'll #colour code it in groups to make navigating easier.
 

#Also, Im unnecessarily looping many times, I know this, but I don't know how to do 8*20 = 160, so I'll just stick with what I #DO know, and that every 8 minutes you earn 1 resin.
 

#So yes, I am aware there are more loops than needed
#you don't need to inform me
 

#Oh yeah, since I # all of the non-code related stuff, you should be able to just Ctrl+A, Ctrl+V, without the need of deleting #this stuff
#I feel like this would have been better in a Pastebin

#I don't care to colour coat anything this time, just go look at my original paste for a general idea, because I didn't re-arrange anything, just added some things on

 

#https://justpaste.it/6lvoe OG link

 

#the only reason im not editing my original post, was because I want to keep the satisfaction of predicting Rosaria perfectly, and if the edit message is present AFTER rosaria was released, its not exactly that impressive is it
...
#also im sure there were others that I forgot
